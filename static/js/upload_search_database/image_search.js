function populateSearchImageDropdowns() {
    ...
    var imageDropdowns = [
        { element: $('#searchimage_areaDropdown'), dataKey: 'searchimage_area' },
        { element: $('#searchimage_equipmentGroupDropdown'), dataKey: 'searchimage_equipment_group' },
        { element: $('#searchimage_modelDropdown'), dataKey: 'searchimage_model' },
        { element: $('#searchimage_assetNumberDropdown'), dataKey: 'searchimage_asset_number' },
        { element: $('#searchimage_locationDropdown'), dataKey: 'searchimage_location' }
    ];

    // AJAX request to fetch data for Image form dropdowns
    $.ajax({
        url: '/get_search_image_list_data_bp', // URL to fetch data from
        type: 'GET',
        success: function(data) {
            // Populate areas dropdown
            var areaDropdown = $('#searchimage_areaDropdown');
            ...
            areaDropdown.change(function() {
                ...
                var equipmentGroupDropdown = $('#searchimage_equipmentGroupDropdown');
            ...
            $('#searchimage_equipmentGroupDropdown').change(function() {
                var selectedGroupId = $(this).val();
                var modelDropdown = $('#searchimage_modelDropdown');
            ...
            $('#searchimage_modelDropdown').change(function() {
                var selectedModelId = $(this).val();
                var assetNumberDropdown = $('#searchimage_assetNumberDropdown');
                ...
                var locationDropdown = $('#searchimage_locationDropdown');
            ...
            $('#searchimage_areaDropdown').change();
        },
